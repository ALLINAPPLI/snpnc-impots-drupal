export default
{
  ...
  home : {
    introduction : ` Le calcul de vos frais réels est facilité et optimisé par
    ...
    <br/><strong>NB : L'utilisation de cet outil informatique ne saurait engager la
    responsabilité du SNPNC, si des erreurs ou omissions étaient relevées
    par l'administration.</strong></p>`,
    compagnie: {
      title       : "Compagnie",
